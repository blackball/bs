...
static void test_color() {
	...
	if (bs_initModel(&bg, (unsigned char*)frame->imageData, frame->width, frame->height, frame->nChannels)){
...
static void test_gray(){
	...
	if (bs_initModel(&bg, (unsigned char*)gray->imageData, gray->width, gray->height, gray->nChannels)){
		fprintf(stderr, "Error:initialize bs module failed!\n");
		return ;
	}
